<template>
    ...
    <div class="bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 sticky top-0 z-50 flex border-b lg:ps-75  bg-base-100 border-base-content/20 sticky top-0 z-50 flex border-b lg:ps-75 ">
        ...
        <nav class=" navbar py-2">
          <div class="navbar-start gap-2">
            ...
            <button
              type="button"
              class="bg-successmax-sm:btn max-sm:btn-text max-sm:btn-sm max-sm:btn-square flex items-center gap-2 text-sm"
              aria-haspopup="dialog"
              aria-expanded="false"
  ...
  <!-- ---------- NAVBAR ---------- -->
<nav class="navbar">
    <div class="mx-auto w-full max-w-8xl px-4 py-4 sm:px-6 lg:flex lg:items-center lg:gap-3 lg:px-6">
      <div class="navbar-start items-center justify-between max-lg:w-full">
        <a
            ...
            href="#">
            <img src="../assets/images/logo.png" class="size-8" alt="brand-logo" />
      ...
      <div class=" flex items-center px-10 ">
          <button
            ...
            <span class="icon-[tabler--menu-2] collapse-open:hidden size-5.5">name</span>
            <span class="icon-[tabler--x] collapse-open:block hidden size-5.5"></span>
          </button>
        </div>

        <p>Sale $20 off Your Fisrt Order</p>
    </div>
  </nav>
